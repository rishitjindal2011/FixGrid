    ...
    <footer className="mt-auto border-t border-hairline bg-enamel text-bench py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-10 border-b border-enamel-lift">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-display text-xl font-bold uppercase tracking-tight text-bench">
                FIX<span className="text-signal">GRID</span> BENCH CAREERS
              </span>
            </div>
            <p className="mt-3 text-xs text-bench/70 max-w-md leading-relaxed">
              FixGrid Careers is the certified hardware technician and micro-soldering job exchange.
              Connecting verified repair labs with bench specialists across India with zero placement markups.
            </p>
            <div className="mt-4 flex items-center gap-2 text-xs text-bench/80">
              <ShieldCheck className="size-4 text-verdigris" />
              <span className="font-mono text-[11px]">All job vacancies mapped to verified physical workshop addresses</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-bench/70">
              ...
              <li>
                <a href="#standards" className="hover:text-bench transition-colors">
                  Bench Hardware Standards
                </a>
              </li>
              <li>
                <a href="mailto:support@vytron.me" className="hover:text-bench transition-colors">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[11px] text-bench/50">
          <p>© {new Date().getFullYear()} FixGrid · hiring.vytron.me. All rights reserved.</p>
