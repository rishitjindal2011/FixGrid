...
import { ArrowRight, Loader2, Store, Lock } from "lucide-react";
...
function LoginForm() {
  ...
  return (
    <AuthShell
      title="FixGrid Sign In"
      intro="Access your technician profile, apply for bench openings, or manage your workshop recruitment desk."
      footer={
        <>
          New to FixGrid?{" "}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          <Field label="Email Address" htmlFor="email">
            <input
              ...
              placeholder="e.g. rahul@example.com or tech@workshop.fixgrid"
        ...
        <div className="mt-2 flex items-start gap-3 rounded-machined border border-hairline bg-bench p-3.5">
          ...
          <div className="min-w-0">
            <p className="font-display text-xs uppercase tracking-wide text-enamel font-bold">
              Are you a repair workshop or lab?
            </p>
            <p className="mt-0.5 text-xs leading-relaxed text-steel">
              List your workshop bench to broadcast vacancies and manage applicant pipelines.{" "}
              <Link
