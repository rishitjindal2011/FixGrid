...
output_dir = r"C:\Users\Rishit Jindal\.gemini\antigravity-ide\brain\bc194417-f73a-4e14-9f73-4cbc3eb5a251\scratch\canva_live_slides_new"
...
print(f"Total document image URLs: {len(urls)}")
