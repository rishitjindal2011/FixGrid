...
import { GoogleSignInClerk } from "@/components/auth/google-sign-in-clerk";
import { Input } from "@/components/ui/input";
import { DEFAULT_SIGNED_IN_PATH } from "@/lib/auth/paths";

export function SignInFormClerk({ next, linkError }: { next?: string; linkError?: boolean }) {
