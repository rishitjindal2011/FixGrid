 ...
 * observer, no client component. Review notes and dispute resolutions are the
 * main callers, and both are the kind of thing an operator writes three lines
 * of and then reconsiders.
 */
