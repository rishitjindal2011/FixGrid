...
export default function StockistJoinPage() {
  const { user } = useAuth();
  ...
  const [specialization, setSpecialization] = useState("OEM Logic Board Components & ICs");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (files.length === 0) {
      setError("Please attach at least one piece of physical evidence (warehouse/storefront photo, test jig photo, or GST/registration certificate).");
      return;
    }
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Failed to submit supplier registration.");
      }
          ...
          <div className="max-w-2xl mx-auto bg-neutral-900/90 border border-neutral-800 rounded-2xl p-8 sm:p-10 shadow-2xl backdrop-blur-xl animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="text-center space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-xs font-mono font-medium text-emerald-400">
                SUPPLIER DOSSIER QUEUED
              </div>
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white">
                Parts Supplier Verification Transmitted
              </h1>
              <p className="text-neutral-400 text-sm leading-relaxed max-w-lg mx-auto">
                Your stockist onboarding dossier for <span className="text-white font-semibold">{shopName}</span> has been transmitted to the FixGrid Administration Console.
              </p>
            </div>
            ...
            <div className="mt-8 bg-neutral-950/70 border border-neutral-800/80 rounded-xl p-5 space-y-3 text-xs font-mono">
              <div className="flex justify-between items-center py-1.5 border-b border-neutral-800/60">
                ...
                <span className="text-emerald-400 font-bold">parts.vytron.me</span>
              </div>
              <div className="flex justify-between items-center py-1.5 border-b border-neutral-800/60">
              ...
              <div className="flex justify-between items-center py-1.5 border-b border-neutral-800/60">
                <span className="text-neutral-500">STOCKIST SLUG</span>
            ...
            <div className="mt-6 rounded-xl bg-orange-500/5 border border-orange-500/20 p-4 text-xs text-orange-300 leading-relaxed flex items-start gap-3">
              ...
              <div>
                <strong>Next Steps:</strong> Platform administrators audit inventory legitimacy, warehouse photos, and tax registrations within 12–24 business hours. Once accepted in the admin console, your supplier catalog and parts stock will automatically become public across the platform.
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-xs font-mono font-semibold text-orange-400 mb-4">
                  ...
                  SUPPLIER VERIFICATION & ONBOARDING DESK
                </div>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white leading-tight">
                  List your component inventory desk on FixGrid
                </h1>
                <p className="mt-4 text-base sm:text-lg text-neutral-400 leading-relaxed">
                  Join the trusted hardware supply exchange. To eliminate counterfeit ICs, defective pulled silicon, and ghost listings, every component supplier must furnish physical warehouse verification and business tax credentials prior to public listing.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 p-5 rounded-2xl bg-neutral-900/60 border border-neutral-800">
                  ...
                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-wider text-white">
                      Physical Stock & Testing Evidence
                    </h3>
                    <p className="mt-1 text-xs sm:text-sm text-neutral-400 leading-relaxed">
                      Upload clear photographs of your storage bins, component reels, ESD trays, multimeter/oscilloscope testing benches, or storefront sign.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-5 rounded-2xl bg-neutral-900/60 border border-neutral-800">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs sm:text-sm text-neutral-400 leading-relaxed">
                      Furnish your GSTIN, Trade License, or Corporate Tax registration to guarantee legitimate wholesale operations and authentic invoicing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-5 rounded-2xl bg-neutral-900/60 border border-neutral-800">
                  ...
                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-wider text-white">
                      Dual Fulfillment Controls
                    </h3>
                    <p className="mt-1 text-xs sm:text-sm text-neutral-400 leading-relaxed">
                      Offer nationwide courier dispatch with escrow protection, or enable counter pickup with our 20% advance reservation fee model.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-neutral-900/40 border border-neutral-800 text-xs text-neutral-400 leading-relaxed">
                <span className="text-neutral-200 font-semibold">Security Protocol:</span> Registrations are routed directly to the FixGrid Admin Console. Your supplier catalog remains hidden from public view until authorized by platform administrators.
              </div>
            </div>
            ...
            <div className="bg-neutral-900/90 border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
              <div className="mb-6">
                ...
                <p className="text-xs text-neutral-400 mt-1">
                  All fields are verified by platform administrators before inventory goes live.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-neutral-300 mb-1">
                      Supplier / Storefront Trade Name *
                    </label>
                    <input
                      type="text"
                      required
                      ...
                      placeholder="e.g. Precision Silicon & OEM Depot"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g. Precision Depot Pvt Ltd"
                        className="w-full px-3.5 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 transition-colors"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g. 27AABCP5678Q1Z2"
                ...
                <div className="space-y-3 pt-2">
                  <div className="text-xs font-mono uppercase tracking-wider text-orange-400 font-bold border-b border-neutral-800 pb-1">
                    2. Primary Contact & Inventory Access
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="dispatch@precisionsilicon.com"
                        className="w-full px-3.5 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  {!user && (
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 transition-colors"
                      />
                      <span className="text-[10px] text-neutral-500 mt-1 block">Used to log in to your inventory and order management portal.</span>
                    </div>
                  )}
                </div>

                {/* 3. Physical Warehouse / Counter Address */}
                <div className="space-y-3 pt-2">
                  <div className="text-xs font-mono uppercase tracking-wider text-orange-400 font-bold border-b border-neutral-800 pb-1">
                    3. Warehouse & Counter Location
                  </div>

                  <div>
                    <label className="block text-xs font-medium text-neutral-300 mb-1">
                      Warehouse / Shop Physical Street Address *
                    </label>
                    <textarea
                      required
                      rows={2}
                      ...
                      placeholder="e.g. Unit 4B, Electronic Hardware Hub, Lamington Road"
                      className="w-full px-3.5 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Mumbai, Maharashtra - 400007"
                      className="w-full px-3.5 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 transition-colors"
                    />
                  </div>
                </div>

                {/* 4. Specialization & Scope */}
                <div className="space-y-3 pt-2">
                  <div className="text-xs font-mono uppercase tracking-wider text-orange-400 font-bold border-b border-neutral-800 pb-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      >
                        <option value="OEM Logic Board Components & ICs">OEM Logic Board ICs & Silicon</option>
                        <option value="Tested Pulled Motherboards & Donor Boards">Donor Boards & Assemblies</option>
                        <option value="OLED Displays & Digitizers">OLED Displays & Digitizers</option>
                        <option value="Batteries & Power Delivery Modules">Batteries & Power Modules</option>
                        <option value="Camera Modules & Optical Sensors">Camera Sensors & Optics</option>
                        <option value="Micro-Soldering Consumables & Stencils">Consumables, Stencils & Solder</option>
                      </select>
                    </div>

                    <div>
                      <label className="block text-xs font-medium text-neutral-300 mb-1">
                        Testing / Packing Benches
                      </label>
                      <input
                        type="number"
                        min="1"
                ...
                <div className="space-y-3 pt-2">
                  <div className="text-xs font-mono uppercase tracking-wider text-orange-400 font-bold border-b border-neutral-800 pb-1 flex items-center justify-between">
                    <span>5. Physical Stock & Legal Evidence *</span>
                  ...
                  <div className="p-4 border-2 border-dashed border-neutral-800 rounded-2xl bg-neutral-950/50 hover:bg-neutral-950 hover:border-neutral-700 transition-all text-center">
                    ...
                    <p className="text-[11px] text-neutral-500 mt-1">
                      Warehouse rack photo, testing jig photo, or GST/Trade registration certificate
                    </p>
                  </div>
                ...
                <div className="pt-2">
                  ...
                  <textarea
                    ...
                    placeholder="Courier dispatch radius, return/warranty policies on ICs, wholesale MOQ terms..."
                ...
                <div className="pt-4">
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        Submit Supplier for Administrative Review
                        <ArrowRight className="w-4 h-4" />
                      </>
                    )}
                  </button>
